/**
 * File structure and content from fs-node-vue.
 * Used to populate memfs for MemFileSystem service verification.
 *
 * Paths are relative to project root. node_modules is represented as
 * directory structure only (empty placeholder) - real deps come from npm install.
 */
