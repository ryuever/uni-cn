/**
 * Project content from /tmp/my-vue-app (after adding button component).
 * Excludes node_modules and package-lock.json.
 * Paths are relative to project root.
 */
export const ADD_BUTTON_VUE_PROJECT_FILES: Record<string, string> = {
...
*.sw?
`,
  '.vscode/extensions.json': JSON.stringify({ recommendations: ['Vue.volar'] }, null, 2),
...
`,
  'src/components/ui/button/index.ts': `import type { VariantProps } from "class-variance-authority"
...
`,
  'src/components/ui/button/Button.vue': `<script setup lang="ts">
